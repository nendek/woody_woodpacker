...
static char woody64[] = 
"";

//"";
...
static void		modify_woody(t_info *info, void *new_file)
{
	...
	val = info->offset_loader - info->base_entry;
	...
	val = - 130 - offset;
	ft_memcpy(woody64 + 126, &(val), sizeof(uint32_t));

	// put .text begin addr again again
 	val = - 165 - offset;
 	ft_memcpy(woody64 + 161, &(val), sizeof(uint32_t));
